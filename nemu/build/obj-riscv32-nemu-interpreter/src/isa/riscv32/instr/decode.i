  ...
  ((void)sizeof((idx >= 0 && idx < 32) ? 1 : 0), __extension__({
     if (idx >= 0 && idx < 32)
       ...
       __assert_fail("idx >= 0 && idx < 32",
                     "src/isa/riscv32/instr/../local-include/reg.h", 7,
...
static inline int table_lui(Decode *s) { return EXEC_ID_lui; }
static inline int table_lb(Decode *s) { return EXEC_ID_lb; }
static inline int table_lbu(Decode *s) { return EXEC_ID_lbu; }
static inline int table_lh(Decode *s) { return EXEC_ID_lh; }
static inline int table_lhu(Decode *s) { return EXEC_ID_lhu; }
static inline int table_lw(Decode *s) { return EXEC_ID_lw; }
static inline int table_sw(Decode *s) { return EXEC_ID_sw; }
static inline int table_sh(Decode *s) { return EXEC_ID_sh; }
static inline int table_sb(Decode *s) { return EXEC_ID_sb; }
static inline int table_addi(Decode *s) { return EXEC_ID_addi; }
static inline int table_andi(Decode *s) { return EXEC_ID_andi; }
static inline int table_slli(Decode *s) { return EXEC_ID_slli; }
static inline int table_sltiu(Decode *s) { return EXEC_ID_sltiu; }
static inline int table_sll(Decode *s) { return EXEC_ID_sll; }
static inline int table_srl(Decode *s) { return EXEC_ID_srl; }
static inline int table_sra(Decode *s) { return EXEC_ID_sra; }
static inline int table_srli(Decode *s) { return EXEC_ID_srli; }
static inline int table_srai(Decode *s) { return EXEC_ID_srai; }
static inline int table_xori(Decode *s) { return EXEC_ID_xori; }
static inline int table_ori(Decode *s) { return EXEC_ID_ori; }
static inline int table_slti(Decode *s) { return EXEC_ID_slti; }
static inline int table_auipc(Decode *s) { return EXEC_ID_auipc; }
static inline int table_add(Decode *s) { return EXEC_ID_add; }
static inline int table_sub(Decode *s) { return EXEC_ID_sub; }
static inline int table_xor(Decode *s) { return EXEC_ID_xor; }
static inline int table_or(Decode *s) { return EXEC_ID_or; }
static inline int table_and(Decode *s) { return EXEC_ID_and; }
static inline int table_mul(Decode *s) { return EXEC_ID_mul; }
static inline int table_mulh(Decode *s) { return EXEC_ID_mulh; }
static inline int table_div(Decode *s) { return EXEC_ID_div; }
static inline int table_divu(Decode *s) { return EXEC_ID_divu; }
static inline int table_rem(Decode *s) { return EXEC_ID_rem; }
static inline int table_remu(Decode *s) { return EXEC_ID_remu; }
static inline int table_slt(Decode *s) { return EXEC_ID_slt; }
static inline int table_sltu(Decode *s) { return EXEC_ID_sltu; }
static inline int table_beq(Decode *s) { return EXEC_ID_beq; }
static inline int table_bne(Decode *s) { return EXEC_ID_bne; }
static inline int table_blt(Decode *s) { return EXEC_ID_blt; }
static inline int table_bge(Decode *s) { return EXEC_ID_bge; }
static inline int table_bltu(Decode *s) { return EXEC_ID_bltu; }
static inline int table_bgeu(Decode *s) { return EXEC_ID_bgeu; }
static inline int table_jal(Decode *s) { return EXEC_ID_jal; }
static inline int table_jalr(Decode *s) { return EXEC_ID_jalr; }
static inline int table_ecall(Decode *s) { return EXEC_ID_ecall; }
static inline int table_csrrw(Decode *s) { return EXEC_ID_csrrw; }
static inline int table_csrrs(Decode *s) { return EXEC_ID_csrrs; }
static inline int table_mret(Decode *s) { return EXEC_ID_mret; }
static inline int table_inv(Decode *s) { return EXEC_ID_inv; }
static inline int table_nemu_trap(Decode *s) { return EXEC_ID_nemu_trap; };
...
static void decode_op_r(Decode *s, Operand *op, word_t val, _Bool flag) {
  ...
  op->preg =
      (is_write && val == 0) ? &zero_null : &(cpu.gpr[check_reg_idx(val)]._32);
}

static void decode_R(Decode *s, int width) {
  decode_op_r(s, (&s->src1), s->isa.instr.r.rs1, 0);
  decode_op_r(s, (&s->src2), s->isa.instr.r.rs2, 0);
  decode_op_r(s, (&s->dest), s->isa.instr.r.rd, 1);
}
...
static void decode_J(Decode *s, int width) {
  ...
  decode_op_i(s, (&s->src1), simm, 0);
  decode_op_r(s, (&s->dest), s->isa.instr.j.rd, 1);
}
...
static void decode_B(Decode *s, int width) {
  decode_op_r(s, (&s->src1), s->isa.instr.b.rs1, 0);
  sword_t simm = (s->isa.instr.b.simm12 << 12) | (s->isa.instr.b.imm10_5 << 5) |
                 (s->isa.instr.b.imm4_1 << 1) | (s->isa.instr.b.imm11 << 11);
  decode_op_i(s, (&s->src2), simm, 0);
  decode_op_r(s, (&s->dest), s->isa.instr.b.rs2, 0);
}

static inline int table_add_sub_mul(Decode *s) {
  do {
    uint32_t key, mask, shift;
    pattern_decode("0000000 ????? ????? ??? ????? ????? ??",
                   (sizeof("0000000 ????? ????? ??? ????? ????? ??") - 1), &key,
                   &mask, &shift);
  ...
  do {
    uint32_t key, mask, shift;
    pattern_decode("0100000 ????? ????? ??? ????? ????? ??",
                   (sizeof("0100000 ????? ????? ??? ????? ????? ??") - 1), &key,
                   &mask, &shift);
    if (((get_instr(s) >> shift) & mask) == key) {
      {
        decode_empty(s, 0);
  ...
  do {
    uint32_t key, mask, shift;
    pattern_decode("0000001 ????? ????? ??? ????? ????? ??",
                   (sizeof("0000001 ????? ????? ??? ????? ????? ??") - 1), &key,
                   &mask, &shift);
    if (((get_instr(s) >> shift) & mask) == key) {
      {
        decode_empty(s, 0);
...
static inline int table_srli_srai(Decode *s) {
  do {
    uint32_t key, mask, shift;
    pattern_decode("0000000 ????? ????? ??? ????? ????? ??",
                   (sizeof("0000000 ????? ????? ??? ????? ????? ??") - 1), &key,
...
static inline int table_sll_mulh(Decode *s) {
  do {
    uint32_t key, mask, shift;
    pattern_decode("0000000 ????? ????? ??? ????? ????? ??",
                   (sizeof("0000000 ????? ????? ??? ????? ????? ??") - 1), &key,
...
static inline int table_srl_sra_divu(Decode *s) {
  do {
    uint32_t key, mask, shift;
    pattern_decode("0000000 ????? ????? ??? ????? ????? ??",
                   (sizeof("0000000 ????? ????? ??? ????? ????? ??") - 1), &key,
...
static inline int table_xor_div(Decode *s) {
  do {
    uint32_t key, mask, shift;
    pattern_decode("0000000 ????? ????? ??? ????? ????? ??",
                   (sizeof("0000000 ????? ????? ??? ????? ????? ??") - 1), &key,
...
static inline int table_or_rem(Decode *s) {
  do {
    uint32_t key, mask, shift;
    pattern_decode("0000000 ????? ????? ??? ????? ????? ??",
                   (sizeof("0000000 ????? ????? ??? ????? ????? ??") - 1), &key,
...
static inline int table_and_remu(Decode *s) {
  do {
    uint32_t key, mask, shift;
    pattern_decode("0000000 ????? ????? ??? ????? ????? ??",
                   (sizeof("0000000 ????? ????? ??? ????? ????? ??") - 1), &key,
...
static inline int table_cal_imm(Decode *s) {
  do {
    uint32_t key, mask, shift;
    pattern_decode("??????? ????? ????? 000 ????? ????? ??",
                   (sizeof("??????? ????? ????? 000 ????? ????? ??") - 1), &key,
...
static inline int table_cal(Decode *s) {
  do {
    uint32_t key, mask, shift;
    pattern_decode("??????? ????? ????? 000 ????? ????? ??",
                   (sizeof("??????? ????? ????? 000 ????? ????? ??") - 1), &key,
...
static inline int table_csr(Decode *s) {
  do {
    uint32_t key, mask, shift;
    pattern_decode("0000000 00000 00000 000 00000 ????? ??",
                   (sizeof("0000000 00000 00000 000 00000 ????? ??") - 1), &key,
                   &mask, &shift);
    if (((get_instr(s) >> shift) & mask) == key) {
      {
        decode_empty(s, 0);
        return table_ecall(s);
      };
    }
  } while (0);
  do {
  ...
  do {
    ...
    if (((get_instr(s) >> shift) & mask) == key) {
      {
        decode_empty(s, 0);
        return table_csrrs(s);
      };
    }
  } while (0);
  do {
    uint32_t key, mask, shift;
    pattern_decode("0011000 00010 00000 000 00000 ????? ??",
                   (sizeof("0011000 00010 00000 000 00000 ????? ??") - 1), &key,
                   &mask, &shift);
    if (((get_instr(s) >> shift) & mask) == key) {
      {
        decode_empty(s, 0);
...
static inline int table_main(Decode *s) {
  ...
  do {
    uint32_t key, mask, shift;
    pattern_decode("??????? ????? ????? ??? ????? 01000 11",
                   (sizeof("??????? ????? ????? ??? ????? 01000 11") - 1), &key,
                   &mask, &shift);
    if (((get_instr(s) >> shift) & mask) == key) {
      {
        decode_S(s, 0);
  ...
  do {
    uint32_t key, mask, shift;
    pattern_decode("??????? ????? ????? ??? ????? 00100 11",
                   (sizeof("??????? ????? ????? ??? ????? 00100 11") - 1), &key,
                   &mask, &shift);
    if (((get_instr(s) >> shift) & mask) == key) {
      {
        decode_I(s, 0);
        return table_cal_imm(s);
      };
    }
  } while (0);
  do {
  ...
  do {
    uint32_t key, mask, shift;
    pattern_decode("??????? ????? ????? ??? ????? 11001 11",
                   (sizeof("??????? ????? ????? ??? ????? 11001 11") - 1), &key,
                   &mask, &shift);
    if (((get_instr(s) >> shift) & mask) == key) {
      {
        decode_I(s, 0);
  ...
  do {
    uint32_t key, mask, shift;
    pattern_decode("??????? ????? ????? ??? ????? 01100 11",
                   (sizeof("??????? ????? ????? ??? ????? 01100 11") - 1), &key,
                   &mask, &shift);
    if (((get_instr(s) >> shift) & mask) == key) {
      {
        decode_R(s, 0);
  ...
  do {
    uint32_t key, mask, shift;
    pattern_decode("??????? ????? ????? ??? ????? 11000 11",
                   (sizeof("??????? ????? ????? ??? ????? 11000 11") - 1), &key,
                   &mask, &shift);
    if (((get_instr(s) >> shift) & mask) == key) {
      {
        decode_B(s, 0);
  ...
  do {
    uint32_t key, mask, shift;
    pattern_decode("??????? ????? ????? ??? ????? 11100 11",
                   (sizeof("??????? ????? ????? ??? ????? 11100 11") - 1), &key,
                   &mask, &shift);
    if (((get_instr(s) >> shift) & mask) == key) {
      {
        decode_I(s, 0);
  ...
  do {
    uint32_t key, mask, shift;
    pattern_decode("??????? ????? ????? ??? ????? 11010 11",
                   (sizeof("??????? ????? ????? ??? ????? 11010 11") - 1), &key,
                   &mask, &shift);
    if (((get_instr(s) >> shift) & mask) == key) {
      {
        decode_empty(s, 0);
        return table_nemu_trap(s);
      };
    }
  } while (0);
  return table_inv(s);
