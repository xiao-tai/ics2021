...
static void welcome() {
  do {
    printf("\33[1;34m"
           ...
           "\33[0m"
           "\n",
           "src/monitor/monitor.c", 13, __func__,
           "\33[1;32m"
           "ON"
           "\33[0m");
    do {
  ...
  do {
    printf("\33[1;34m"
           ...
           "\33[0m"
           "\n",
           "src/monitor/monitor.c", 14, __func__);
    do {
      extern FILE *log_fp;
      extern _Bool log_enable();
      if (log_enable()) {
  ...
  do {
    printf("\33[1;34m"
           ...
           "\33[0m"
           "\n",
           "src/monitor/monitor.c", 17, __func__, "15:56:29", "Nov 14 2023");
    do {
      extern FILE *log_fp;
      extern _Bool log_enable();
      if (log_enable()) {
        fprintf(log_fp,
                ...
                "\33[0m"
                "\n",
                "src/monitor/monitor.c", 17, __func__, "15:56:29",
                "Nov 14 2023");
        fflush(log_fp);
      }
    } while (0);
...
static long load_img() {
  if (img_file == ((void *)0)) {
    do {
      printf("\33[1;34m"
             ...
             "\33[0m"
             "\n",
             "src/monitor/monitor.c", 36, __func__);
      do {
        extern FILE *log_fp;
        extern _Bool log_enable();
        if (log_enable()) {
    ...
    if (!(fp)) {
      ...
      ((void)sizeof((fp) ? 1 : 0), __extension__({
         if (fp)
           ...
           __assert_fail("fp", "src/monitor/monitor.c", 41,
  ...
  do {
    printf("\33[1;34m"
           ...
           "\33[0m"
           "\n",
           "src/monitor/monitor.c", 46, __func__, img_file, size);
    do {
      extern FILE *log_fp;
      extern _Bool log_enable();
      if (log_enable()) {
  ...
  ((void)sizeof((ret == 1) ? 1 : 0), __extension__({
     if (ret == 1)
       ...
       __assert_fail("ret == 1", "src/monitor/monitor.c", 50,
                     __extension__ __PRETTY_FUNCTION__);
   }));
