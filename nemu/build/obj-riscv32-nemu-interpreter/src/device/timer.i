...
static uint32_t *rtc_port_base = ((void *)0);

static void rtc_io_handler(uint32_t offset, int len, _Bool is_write) {

  ((void)sizeof((offset == 0 || offset == 4) ? 1 : 0), __extension__({
     if (offset == 0 || offset == 4)
       ;
     else
       __assert_fail("offset == 0 || offset == 4", "src/device/timer.c", 8,
