...
static uint8_t *serial_base = ((void *)0);

static void serial_putc(char ch) { putc(ch, stderr); }

static void serial_io_handler(uint32_t offset, int len, _Bool is_write) {

  ((void)sizeof((len == 1) ? 1 : 0), __extension__({
     if (len == 1)
       ;
     else
       __assert_fail("len == 1", "src/device/serial.c", 17,
        ...
        if (!(0)) {
          ...
          ((void)sizeof((0) ? 1 : 0), __extension__({
             if (0)
               ...
               __assert_fail("0", "src/device/serial.c", 22,
                             __extension__ __PRETTY_FUNCTION__);
           }));
        }
      } while (0);
      ...
      if (!(0)) {
        ...
        ((void)sizeof((0) ? 1 : 0), __extension__({
           if (0)
             ...
             __assert_fail("0", "src/device/serial.c", 24,
                           __extension__ __PRETTY_FUNCTION__);
         }));
      }
    } while (0);
