  ...
  default:
    ((void)sizeof((0) ? 1 : 0), __extension__({
       if (0)
         ...
         __assert_fail("0", "/home/ziqiang/ics2021/nemu/include/memory/host.h",
      ...
      if (!(map != ((void *)0))) {
        ...
        ((void)sizeof((map != ((void *)0)) ? 1 : 0), __extension__({
           if (map != ((void *)0))
             ...
             __assert_fail("map != ((void *)0)", "src/device/io/map.c", 22,
...
void init_map() {
  ...
  ((void)sizeof((io_space) ? 1 : 0), __extension__({
     if (io_space)
       ...
       __assert_fail("io_space", "src/device/io/map.c", 36,
                     __extension__ __PRETTY_FUNCTION__);
   }));
  p_space = io_space;
}
...
word_t map_read(paddr_t addr, int len, IOMap *map) {
  ...
  ((void)sizeof((len >= 1 && len <= 8) ? 1 : 0), __extension__({
     if (len >= 1 && len <= 8)
       ...
       __assert_fail("len >= 1 && len <= 8", "src/device/io/map.c", 41,
                     __extension__ __PRETTY_FUNCTION__);
   }));
...
void map_write(paddr_t addr, int len, word_t data, IOMap *map) {
  ...
  ((void)sizeof((len >= 1 && len <= 8) ? 1 : 0), __extension__({
     if (len >= 1 && len <= 8)
       ...
       __assert_fail("len >= 1 && len <= 8", "src/device/io/map.c", 54,
                     __extension__ __PRETTY_FUNCTION__);
   }));
  check_bound(map, addr);
  paddr_t offset = addr - map->low;
